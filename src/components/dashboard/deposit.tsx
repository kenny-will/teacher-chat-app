...
const TRX_ADDRESS = process.env.NEXT_PUBLIC_TRX_ADDRESS;
...
function NetworkBadge({
  ...
  net: (typeof CRYPTO_NETWORKS)[number];
  size?: number;
}) {
  return (
...
function PendingDepositRow({
  ...
  const [editAmt, setEditAmt] = useState(txn.amount.replace(/[^0-9.]/g, ""));
  ...
  if (editing) {
    return (
      <div className="rounded-xl border border-blue-200 dark:border-blue-500/30 bg-blue-50/50 dark:bg-blue-950/10 p-3.5 space-y-2.5">
        <div className="text-[11.5px] font-semibold text-blue-700 dark:text-blue-400 mb-1">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div>
            ...
            <div className="flex items-center rounded-lg border border-gray-200 dark:border-white/10 overflow-hidden bg-white dark:bg-transparent">
              <span className="px-3 text-[12px] text-gray-400 border-r border-gray-200 dark:border-white/10 h-9 flex items-center shrink-0">
                $
              </span>
              <input
                type="number"
    ...
    <div className="flex items-center gap-3 rounded-xl border border-amber-100 dark:border-amber-900/30 bg-amber-50/50 dark:bg-amber-950/10 px-3.5 py-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-[11px] text-gray-500 dark:text-gray-400">
          {txn.accountRef} · {txn.transactionDate}
        </div>
      </div>
      <div className="text-right mr-1">
        ...
        <Tag tone="amber" className="mt-0.5">
          Pending
        </Tag>
      </div>
...
export function DepositPage() {
  ...
  const { data: txnsData, refetch } = useServerData(
    () => queryTransactions(),
    [],
  );
  ...
  async function handleInitiateDeposit() {
    ...
    try {
      ...
      flash(
        "success",
        `Deposit request of $${numeric.toLocaleString("en-US", { minimumFractionDigits: 2 })} submitted — your instructor will review and approve it.`,
      );
      setDepositAmount("");
      setDepositDesc("");
      setDepositMemo("");
          ...
          <div className="col-span-12 lg:col-span-7 space-y-4">
            ...
            <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-5">
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  <div
                    key={s.label}
                    className="rounded-lg bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 px-3 py-2.5"
                  >
                    <div className="text-[10.5px] text-gray-500 dark:text-gray-400 font-medium uppercase tracking-wide">
                      {s.label}
                    </div>
                    <div className="text-[12.5px] text-gray-900 dark:text-gray-100 font-semibold mt-0.5">
                      {s.value}
                    </div>
                  </div>
                ))}
            ...
            <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-5">
              <SectionHeader
                ...
                subtitle="Your instructor will review and approve."
              />
              <div className="mt-4 space-y-3">
                {/* Description */}
                <div>
                  <div className="text-[11.5px] text-gray-500 dark:text-gray-400 mb-1.5">
                    Description
                  </div>
                  <input
                    value={depositDesc}
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center rounded-lg border border-gray-200 dark:border-white/10 overflow-hidden">
                      <span className="px-3 text-[12.5px] text-gray-400 border-r border-gray-200 dark:border-white/10 h-10 flex items-center shrink-0">
                        $
                      </span>
                      <input
                        id="ach-amount"
                ...
                <Button
                  ...
                  disabled={
                    !depositAmount || parseFloat(depositAmount) <= 0 || sending
                  }
          ...
          <div className="col-span-12 lg:col-span-5 space-y-4">
            ...
            <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-5">
              <SectionHeader
                ...
                subtitle="Share these to receive ACH transfers"
              />
              <div className="mt-4 space-y-2.5">
                {ACCOUNT_FIELDS.map((f) => (
                  <div
                    key={f.id}
                    className="flex items-center justify-between rounded-xl border border-gray-200 dark:border-white/10 px-3.5 py-3"
                  >
                    <div>
                      <div className="text-[10.5px] text-gray-400 dark:text-gray-500 uppercase tracking-widest font-medium">
                        {f.label}
                      </div>
                      <div className="text-[13px] font-mono font-medium mt-0.5 dark:text-white">
                        {f.value}
                      </div>
                    </div>
                    <button
              ...
              <SectionHeader
                ...
                right={
                  pendingInbound.length > 0 ? (
                    <Tag tone="amber">{pendingInbound.length}</Tag>
                  ) : undefined
                }
              />
          ...
          <div className="col-span-12 rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-5">
            ...
            {settledInbound.length === 0 ? (
              <div className="mt-4 py-12 text-center text-[13px] text-gray-400 dark:text-gray-500">
                No settled deposits yet. Your instructor will add funds to your
                account.
              </div>
            ) : (
              <div className="mt-3">
                ...
                {settledInbound.map((d) => (
                  ...
                  >
                    ...
                    <div className="col-span-2">
                      <Tag tone="neutral">
                        {d.category.replace("Deposit · ", "")}
                      </Tag>
                    </div>
                    <div className="col-span-3 text-[11.5px] text-gray-500 dark:text-gray-400 truncate">
                      {d.accountRef}
                    </div>
                    <div className="col-span-1 text-[11.5px] text-gray-500 dark:text-gray-400">
                      {d.transactionDate}
                    </div>
                    <div className="col-span-2 text-right">
                      ...
                      <Tag
                        tone={
                          d.statusTone as "green" | "rose" | "amber" | "neutral"
                        }
                        className="mt-0.5"
                      >
                        {d.status}
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-12 lg:col-span-7 rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-white/5 p-5">
            <SectionHeader
              ...
              subtitle="Each network has a unique deposit address"
            />
            ...
            <div className="mt-3 flex items-start gap-2.5 rounded-xl bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 px-3.5 py-3">
              ...
              <p className="text-[11.5px] text-amber-700 dark:text-amber-300 leading-relaxed">
                Only send <strong>{activeCrypto.symbol}</strong> to this address
                on the <strong>{activeCrypto.network}</strong>. Sending any
            ...
            <div className="mt-4 grid grid-cols-3 gap-3">
              {[
                ...
                <div
                  key={row.label}
                  className="rounded-lg border border-gray-200 dark:border-white/10 px-3 py-2.5"
                >
                  <div className="text-[10.5px] text-gray-500 dark:text-gray-400 uppercase tracking-wide">
                    {row.label}
                  </div>
                  <div className="text-[12px] font-medium mt-0.5 dark:text-white">
                    {row.value}
                  </div>
                </div>
              ))}
            ...
            <div className="mt-4 space-y-2">
              {CRYPTO_NETWORKS.map((n) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-[12.5px] font-medium dark:text-white">
                      {n.name}
                    </div>
