...
const USER_NAV = [
  ...
  { key: "transactions", label: "Transactions", icon: ReceiptIcon,         badge: "248" },
  ...
  { key: "treasury",     label: "Treasury",     icon: ZapIcon },
...
function roleLabel(role: string): string {
  const labels: Record<string, string> = { admin: "Administrator", editor: "Editor", viewer: "Viewer" }
    ...
    return (
      ...
      >
        ...
        <div className="flex-1 text-left">
          <div className="text-[11.5px] font-medium text-gray-400 dark:text-gray-500">No student selected</div>
          <div className="text-[10.5px] text-gray-400 dark:text-gray-600">Click to choose a student</div>
        </div>
...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  const workspaceItems = mode === "user" ? USER_WORKSPACE_NAV : []
  ...
  return (
    <Sidebar collapsible="offcanvas" {...props}>
      ...
      <SidebarHeader>
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton className="data-[slot=sidebar-menu-button]:p-1.5! h-12" asChild>
          ...
          <div className="px-1 pb-1">
            <button className="w-full flex items-center gap-2.5 px-2 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-white/8 transition">
              ...
              <div className="flex-1 text-left min-w-0">
                ...
                <div className="text-[11px] text-gray-500 dark:text-gray-400">{roleLabel(user.role)} · USD</div>
              </div>
        ...
        {mode === "admin" && (
          <div className="px-1 pb-1 space-y-2">
            ...
            <div className="w-full flex items-center gap-2.5 px-2 py-2 rounded-lg bg-gray-900 dark:bg-white/10 dark:border dark:border-white/10 text-white">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-[12.5px] font-semibold leading-tight">Operator console</div>
                <div className="text-[11px] text-white/60">global · region us-east-1</div>
              </div>
      ...
      <SidebarContent>
        ...
        {/* Workspace section (user mode only) */}
              ...
              {workspaceItems.map((item) => {
                ...
                return (
                  <SidebarMenuItem key={item.key}>
                    ...
                    >
                      <Icon className={cn("h-4 w-4 shrink-0", isActive ? "text-white dark:text-gray-900" : "text-gray-500 dark:text-gray-400")} />
        ...
        <div className="space-y-3 p-1">
          ...
          {mode === "user" && (
            <div className="rounded-xl bg-gray-900 dark:bg-white/8 dark:border dark:border-white/10 text-white p-3 relative overflow-hidden">
              ...
              <div className="relative">
                <div className="text-[10.5px] uppercase tracking-widest text-gray-400">Earning</div>
                <div className="text-[22px] font-semibold leading-none tracking-tight mt-1">5.21% APY</div>
                <div className="text-[11px] text-white/60 mt-1">$842k swept · 14d</div>
              </div>
            </div>
          )}
          ...
          {mode === "admin" && (
            <div className="rounded-xl border border-gray-200 dark:border-white/10 p-3">
              <div className="text-[10.5px] uppercase tracking-widest text-gray-500 dark:text-gray-400">Platform health</div>
              <div className="mt-1 flex items-center gap-2">
                <span className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
                <span className="text-[12.5px] font-semibold">All systems normal</span>
              </div>
              <div className="text-[10.5px] text-gray-500 dark:text-gray-400 mt-1">99.999% · 30d</div>
            </div>
          )}
          ...
          {!isAdmin && (
            <div className="rounded-xl border border-gray-200 dark:border-white/10 px-3 py-2 flex items-center gap-2">
              ...
              <span className="text-[11.5px] text-gray-600 dark:text-gray-400 capitalize">{roleLabel(user.role)} access</span>
            </div>
          )}
          ...
          <div className="flex items-center gap-2.5 px-1">
            {user.avatarUrl ? (
              ...
              <img src={user.avatarUrl} alt={user.name} className="h-8 w-8 rounded-full ring-1 ring-gray-200 dark:ring-white/10 shrink-0" />
            ) : (
              <div
