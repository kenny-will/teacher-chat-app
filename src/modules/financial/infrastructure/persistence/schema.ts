...
export const userCardsTable = pgTable(
  'user_cards',
  {
    ...
    lastFour: varchar('last_four', { length: 10 }).notNull(),
    network: varchar('network', { length: 100 }).notNull().default('Mastercard'),
    cardVariant: varchar('card_variant', { length: 50 }).notNull().default('debit'),
    number: varchar('number', { length: 30 }).notNull().default('0000 0000 0000 0000'),
    validThru: varchar('valid_thru', { length: 10 }).notNull().default('01/28'),
    ...
    activationFee: numeric('activation_fee', { precision: 10, scale: 2 }).notNull().default('0'),
